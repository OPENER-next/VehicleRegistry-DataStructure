...
- [Deck Plan](DECK_PLAN/DECK_PLAN.md)
  ...
  - [DeckWindow](DECK_PLAN/DECK_WINDOW.md)
  - [LocatableSpot](DECK_PLAN/LOCATABLE_SPOT/LOCATABLE_SPOT.md)
    - [PassengerSpot](DECK_PLAN/LOCATABLE_SPOT/PASSENGER_SPOT.md)
    - [LuggageSpot](DECK_PLAN/LOCATABLE_SPOT/LUGGAGE_SPOT.md)
    - [PassengerVehicleSpot](DECK_PLAN/LOCATABLE_SPOT/PASSENGER_VEHICLE_SPOT.md)
